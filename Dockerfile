...
# Create logs directory for the GC and Derby logs
RUN mkdir -p /app/logs

# Map the Maven output (ROOT.war) to the jar name used in CMD
COPY --from=builder /usr/src/easybuggy/target/ROOT.war /app/easybuggy.jar

# Application execution with your specific performance and debug flags
CMD ["java", \
